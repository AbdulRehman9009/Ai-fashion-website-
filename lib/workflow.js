...
export function getStatusColor(status) {
  const colors = {
    OrderCreated: { bg: "bg-gray-100", text: "text-gray-700", border: "border-gray-200" },
    PaymentPending: { bg: "bg-yellow-50", text: "text-yellow-700", border: "border-yellow-200" },
    PaymentConfirmed: { bg: "bg-green-50", text: "text-green-700", border: "border-green-200" },
    TailoringPending: { bg: "bg-purple-50", text: "text-purple-700", border: "border-purple-200" },
    TailoringInProgress: { bg: "bg-purple-100", text: "text-purple-800", border: "border-purple-300" },
    TailoringCompleted: { bg: "bg-indigo-50", text: "text-indigo-700", border: "border-indigo-200" },
    DeliveryPending: { bg: "bg-blue-50", text: "text-blue-700", border: "border-blue-200" },
    OutForPickup: { bg: "bg-orange-50", text: "text-orange-700", border: "border-orange-200" },
    PickedUp: { bg: "bg-orange-100", text: "text-orange-800", border: "border-orange-300" },
    OutForDelivery: { bg: "bg-cyan-50", text: "text-cyan-700", border: "border-cyan-200" },
  ...
  return colors[status] || { bg: "bg-gray-100", text: "text-gray-600", border: "border-gray-200" };
}
