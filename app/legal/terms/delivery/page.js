export default function DeliveryTerms() {
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-slate-950 py-12">
            <div className="container mx-auto px-4 max-w-3xl bg-white dark:bg-slate-900 p-8 rounded-xl shadow-sm border border-green-100 dark:border-slate-800">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Delivery Partner Terms</h1>
                ...
                <div className="space-y-8 text-gray-700 dark:text-slate-300 leading-relaxed">
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-4">1. Delivery Standards</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-4">2. Compensation</h2>
                        <ul className="list-disc pl-5 space-y-2">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-4">3. Vehicle and Safety</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-4">4. Liability</h2>
                        <p>
