export default function CustomerTerms() {
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-slate-950 py-12">
            <div className="container mx-auto px-4 max-w-3xl bg-white dark:bg-slate-900 p-8 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Customer Terms of Service</h1>
                ...
                <div className="space-y-8 text-gray-700 dark:text-slate-300 leading-relaxed">
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-4">1. Ordering and Payments</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-4">2. Returns and Refunds</h2>
                        <ul className="list-disc pl-5 space-y-2">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-4">3. User Conduct</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-4">4. Measurements</h2>
                        <p>
