export default function ShopkeeperTerms() {
    return (
        <div className="min-h-screen bg-gray-50 py-12">
            <div className="container mx-auto px-4 max-w-3xl bg-white p-8 rounded-xl shadow-sm border border-orange-100">
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Shopkeeper Agreement</h1>
                <p className="text-gray-500 mb-8">Last updated: January 2026</p>

                <div className="space-y-8 text-gray-700 leading-relaxed">
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 mb-4">1. Product Listing & Accuracy</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 mb-4">3. Order Fulfillment</h2>
                        <p>
