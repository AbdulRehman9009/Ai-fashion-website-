...
export default function DeliveryEarningsPage() {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-2xl font-bold tracking-tight">Delivery Earnings</h2>
            ...
            <div className="grid gap-4 md:grid-cols-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            {data?.summary?.pending?.count || 0} deliveries processing
                        </p>
                    </CardContent>
                </Card>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Latest earnings from your deliveries</CardDescription>
                </CardHeader>
                <CardContent>
                    {data?.history?.length > 0 ? (
                        ...
                        <p className="text-center text-muted-foreground py-8">
                            No delivery earning history yet
                        </p>
                    )}
                </CardContent>
            </Card>
