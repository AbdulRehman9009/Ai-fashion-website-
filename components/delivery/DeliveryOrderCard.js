...
export default function DeliveryOrderCard({ delivery, onUpdate }) {
    ...
    const statusColors = {
        ...
        OutForPickup: "bg-yellow-100 text-yellow-800",
    ...
    return (
        <Card className={cn(
            "overflow-hidden border-l-4 shadow-md transition-all hover:shadow-lg",
            ...
            <CardHeader className="p-4 bg-gradient-to-r from-green-50 to-white">
                <div className="flex justify-between items-start">
                    <div className="flex gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-lg">{delivery.customer?.name || "Customer"}</h3>
            ...
            <CardContent className="p-4 grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div>
                            <p className="font-medium text-gray-900">Outfit Details</p>
                            <p className="text-sm text-gray-500">Event: {delivery.eventType}</p>
                            <p className="text-sm text-gray-500">Shop: {delivery.shop?.name}</p>
                            <div className="mt-1">
                    ...
                    <div className="bg-gray-50 p-3 rounded-lg border">
                        <div className="flex items-start gap-2">
                            ...
                            <div className="text-sm">
                                ...
                                <p className="text-gray-600">{delivery.deliveryAddress?.name || delivery.customer?.name}</p>
                                ...
                                {delivery.deliveryAddress?.phone && (
                                    <p className="text-gray-600 mt-1">📞 {delivery.deliveryAddress.phone}</p>
                                )}
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-4 border-l pl-4 md:pl-6">
                    {!isDelivered ? (
                        <>
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-semibold uppercase text-gray-500">Delivery Notes</label>
                                <Textarea
                    ...
                    <div className="pt-4 border-t">
                        ...
                        {delivery.urgentBonus > 0 && (
                            <div className="flex justify-between items-center mt-1">
                                <span className="text-sm text-gray-600">Urgent Bonus:</span>
